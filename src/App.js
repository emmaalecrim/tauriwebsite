...
function App() {
  return (
    <div>
      ...
      <h1 className='main-text'><ReactRotationgText items={['Adriano Alecrim ','Software Developer;','Stagate aficionado; ','Fountain Pen enthusiast; ','Cares more about the question than the answer, which is 42; ','Lover of all dogs; ','Reader of poetry; ','Loves shades of purple. ']} /></h1>
